...
#endif
// 37D IS THE DESIRED VALUE FOR SPI_CR1 SO IF THIS DOESN'T WORK TRY COMPLETE 3TD STORE
#ifdef PSTAT_SPI3_TEST
// 01100111110b (03Eh) is Full Duplex WITH spe NOT ENABLED - CPOL=1 CPHA=0
// 01100111101b (03Dh) is Full Duplex WITH spe NOT ENABLED - CPOL=0 CPHA=1 = DAC, BT
  DC32  LIT, SPI3_CR1, LIT, 03Dh, NOOP, SETBITS
// 1100001100111101b (0C33Dh) is UNIDIRECTIONAL OUPUT WITH spe NOT ENABLED
//	DC32	LIT, SPI1_CR1, LIT, 0C33Dh, SETBITS		// ENABLE CONFIG BEFORE
#endif
...
// THIS IS NOT WORKING~!
#ifdef PSTAT_SPI1_TEST
//  DC32	LIT, 6, LIT, SPI1_CR1, SETBIT
  DC32  LIT, SP1_CR1, LIT, 040h, SETBITS
#endif
#ifdef PSTAT_SPI3_TEST
//  DC32	LIT, 6, LIT, SPI3_CR1, SETBIT
  DC32  LIT, SPI3_CR1, LIT, 040h, SETBITS
#endif

// Set CS's AND ADC-RST/PDN pins 1&2, AND BT-RST ON 15 according to logic.
  DC32  LIT, GPIOB_ODR, LIT, 07002h, SETBITS
